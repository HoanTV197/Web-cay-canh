...
<div class="content-wrapper" style="min-height: 564px;">
            <section class="content-header">
                ...
                <div class="breadcrumb">
                    <a class="btn btn-primary btn-sm" href="?pages=lichSuMuaHang&page=1" role="button">
				 Thoát
			</a>
                </div>
            </section>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td class="text-right" colspan="6">
                                                            ...
                                                            <a class="btn btn-primary btn-md" onclick="window.print(document.getElementById('view'))" role="button" >
